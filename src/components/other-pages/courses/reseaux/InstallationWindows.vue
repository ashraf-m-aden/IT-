      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 services-details">
            <div class="services-details-desc">
              <h3>
                Installer toutes les dernieres versions des systemes
                d'operations windows
              </h3>
              <p>
                L’installation de Windows est l’une des tâches les plus
                importantes lors de la mise à niveau de ton ordinateur ou d’une
                réinstallaton à l’état d’usine. C’est une tâche assez simple,
                mais il y a quelques étapes importantes à suivre. Durant cette
                formation, vous allez apprendre les notions à suivre pour
          ...
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/win11.jpeg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/win.jpeg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
          ...
          <div class="col-lg-6 services-details">
            <div class="services-details-desc">
              ...
              <ul>
                <li>
                  Découvrir les nouveautés et les fonctionnalités des systèmes
                  Windows ;
                </li>
                <li>Comprendre la migration vers le système Windows ;</li>
                <li>Maîtriser les systèmes d’exploitation Windows ;</li>
              </ul>
            </div>
          </div>
        </div>
