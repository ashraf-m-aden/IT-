      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 services-details">
            <div class="services-details-desc">
              ...
              <p>
                Angular est un framework de conception d'applications qui permet de créer des
          ...
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/angular-2.jpg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/original.jpg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
            ...
            <div class="services-details-desc">
              <p>
                ...
                <ul>
                  ...
                  <li>
                    comprendre et construire des components Angular ;
                  </li>
                  <li>
