      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 services-details">
            <div class="services-details-desc">
              <h3>MYSQL</h3>
              <p>
                MySQL, qui est un Système de Gestion de Bases de Données Relationnelles (abrégé SGBDR).
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/mysql_2.jpg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
            ...
            <div class="services-details-desc">
              <p>
                ...
                <ul>
                  ...
                  <li>
                    gerer des relations entre les différentes tables d'une base ;
                  </li>
                  <li>
                    selectionner des données selon de nombreux criteres ;
                  </li>
                  <li>
