      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 services-details">
            <div class="services-details-desc">
              ...
              <p>
                Ce cours est destiné aux débutants qui ne connaissent rien à la création
                de sites web et qui n'attendent qu'une chose : comprendre comment creer des pages web,
                pratiquer et surtout poser des bases solides pour la suite de l'apprentissage!
              </p>

              <p>
                Vous apprendrez comment concevoir des pages web simple et statiques avec le language
                HTML, inserer des textes et des images et styliser le tout avec CSS.
              </p>
            </div>
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 services-details-image">
            <img
              v-wow
              src="../../../../assets/img/courses/code.jpeg"
              class="wow fadeInUp"
              alt="image"
            >
          </div>
          ...
          <div class="pricing-table active-plan">
            ...
            <div class="pricing-features">
              <ul>
                ...
                <li class="active">
                  Matériels requis: PC dualcore 4GB ram
                </li>
                <li class="active">
                  Prérequis: Aucun
                </li>
