        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single-works">
              <img
                src="../../../assets/img/works-image/1.jpg"
                alt="image"
              >
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-works">
              <img
                src="../../../assets/img/works-image/2.jpg"
                alt="image"
              >
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-works">
              <img
                src="../../../assets/img/works-image/3.jpg"
                alt="image"
              >
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-works">
              <img
                src="../../../assets/img/works-image/4.jpg"
                alt="image"
              >
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-works">
              <img
                src="../../../assets/img/works-image/5.jpg"
                alt="image"
              >
